...
-- Required first from init.lua — <leader> must be set before plugins load.
...
-- splits AND tmux panes). The plugin is added with the UI plugins; the tmux
-- config has the matching bindings.
